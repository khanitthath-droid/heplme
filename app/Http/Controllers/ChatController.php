    ...
    public function start(ExchangeRequest $exchangeRequest)
    {
        ...
        if ($chatRoom->wasRecentlyCreated) {
            ChatMessage::create([
                ...
                'type' => 'system',
                'message' => 'ระบบได้เปิดช่องทางการสนทนาสำหรับรายการแลกเปลี่ยนหนังสือเรียบร้อยแล้ว ท่านสามารถติดต่อประสานงาน นัดหมายการส่งมอบ หรือส่งรูปภาพเพิ่มเติมผ่านระบบได้อย่างปลอดภัย',
                'is_read' => true,
            ]);
        }
